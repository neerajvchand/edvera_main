...
type SarbMode = "not_started" | "draft" | "ready_for_approval" | "approved" | "submitted";
...
const STATUS_CONFIG: Record<SarbMode, { label: string; bg: string; text: string; icon: typeof CheckCircle2 }> = {
  not_started: { label: "Not Started", bg: "bg-gray-100", text: "text-gray-600", icon: Circle },
  draft: { label: "Draft", bg: "bg-yellow-50", text: "text-yellow-700", icon: Clock },
  ready_for_approval: { label: "Ready for Approval", bg: "bg-blue-50", text: "text-blue-700", icon: Shield },
  approved: { label: "Approved", bg: "bg-emerald-50", text: "text-emerald-700", icon: CheckCircle2 },
  submitted: { label: "Submitted to SARB", bg: "bg-emerald-100", text: "text-emerald-800", icon: CheckCircle2 },
};
