...
import { Scale, CheckCircle2, Loader2, Eye } from "lucide-react";
import { resolveCase, advanceCaseWorkflowStage, updateCaseFields } from "@/services/compliance/updateCase";
        ...
        <div>
          ...
          {canResolve && (
            <div className="space-y-2">
              {workspaceData.case.caseWorkflowStage !== "monitoring_period" && (
                <button
                  onClick={async () => {
                    await advanceCaseWorkflowStage(caseId, "monitoring_period");
                    await updateCaseFields(caseId, { monitoring_started_at: new Date().toISOString() });
                    onResolved();
                  }}
                ...
                >
                  ...
                  Start Monitoring Period (30-60 days)
                </button>
              )}
              <button
